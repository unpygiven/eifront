...
function VideoCarousel() {
  return (
    <Carousel>
      <Carousel.Item>
      <a href={`/video/4/`} style={{textDecoration: 'none'}}>
        <img
      ...
      <Carousel.Item>
      <a href={`/video/3/`} style={{textDecoration: 'none'}}>
        <img
          className="d-block w-100"
          src="https://e0.pxfuel.com/wallpapers/303/523/desktop-wallpaper-gibson-les-paul-guitar.jpg"
          alt="Second slide"
      ...
      <Carousel.Item>
      <a href={`/video/2/`} style={{textDecoration: 'none'}}>
        <img
          className="d-block w-100"
          src="https://e0.pxfuel.com/wallpapers/303/523/desktop-wallpaper-gibson-les-paul-guitar.jpg"
          alt="Third slide"
      ...
      <Carousel.Item>
        <a href={`/video/1/`} style={{textDecoration: 'none'}}>
        <img
          className="d-block w-100"
          src="https://e0.pxfuel.com/wallpapers/303/523/desktop-wallpaper-gibson-les-paul-guitar.jpg"
          alt="Third slide"
